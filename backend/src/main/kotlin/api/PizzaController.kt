...
import models.pizza.Cheese
import models.pizza.Pizza
import models.pizza.Sauce
...
class PizzaController {
    ...
    val pizzas = hashMapOf(
            1 to Pizza("Margharita", Sauce.TOMATO, Cheese.MOZERELLA,
                    listOf(), 1
            ),
            2 to Pizza("Double Pepperoni", Sauce.TOMATO, Cheese.MOZERELLA,
                    listOf(Topping.PEPPERONI, Topping.PEPPERONI), 2
            ),
            3 to Pizza("Tennesee BBQ Chicken", Sauce.BBQ, Cheese.MOZERELLA,
                    listOf(Topping.MARINATED_CHICKEN, Topping.ONION, Topping.HAM), 3
            ),
            4 to Pizza("Kebaben", Sauce.TACO, Cheese.MOZERELLA,
                    listOf(Topping.KEBAB_MEAT, Topping.CORN, Topping.JALEPENOS, Topping.PAPRIKA, Topping.TORTILLA_CHIPS), 4
            ),
            5 to Pizza("Sopp Bacon Spesial", Sauce.TOMATO, Cheese.MOZERELLA,
